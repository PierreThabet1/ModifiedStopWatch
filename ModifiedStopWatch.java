 ...
 */
public class ModifiedStopWatch extends JLabel implements MouseListener, ActionListener {
	...
	private Timer timer; // This update the stopwatch on the display.
	...
	@Override
	/**
	 * This method shows the time the stopwatch was running in.
	 */
